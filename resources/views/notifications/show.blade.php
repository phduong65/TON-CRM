        ...
        <div class="px-6 pt-6 pb-5 border-b border-slate-100 dark:border-slate-700">
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1 min-w-0">
                    {{-- Type badge --}}
                    <span class="inline-flex items-center text-[10px] font-bold px-2 py-0.5 rounded-md uppercase tracking-wider mb-2
        ...
        @if($notification->penaltyUrl())
            <div class="px-6 pb-6">
                <div class="rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-700/30 p-4 flex items-center gap-3">
                    <div class="w-9 h-9 rounded-xl bg-pcrm-100 dark:bg-pcrm-900/40 flex items-center justify-center shrink-0">
                        <i class="bi bi-hammer text-pcrm-600 dark:text-pcrm-400 text-sm"></i>
                    </div>
                    <div class="flex-1 min-w-0">
                    ...
                    <a href="{{ $notification->penaltyUrl() }}"
