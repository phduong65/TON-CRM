...
<div id="rewardDetailModal" class="hidden fixed inset-0 bg-black/50 z-50 items-center justify-center p-4"
    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-xl flex flex-col"
        ...
        {{-- ── Header ── --}}
        <div class="flex items-start justify-between px-6 pt-5 pb-4 border-b border-slate-200 dark:border-slate-700 shrink-0">
            {{-- Loading skeleton --}}
