<div id="createRoleModal" class="hidden fixed inset-0 bg-black/50 z-50 items-center justify-center p-4"
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-2xl w-full max-w-3xl max-h-[92vh] flex flex-col">
        ...
        <form action="{{ route('roles.store') }}" method="POST" class="px-6 py-5 space-y-5 overflow-y-auto">
            @csrf
