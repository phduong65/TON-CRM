<div id="deleteShiftModal" class="hidden fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-2 sm:p-4"
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-2xl w-full max-w-sm p-4 sm:p-6">
        <div class="flex items-center gap-3 mb-4">
            ...
            <div>
                <h3 class="font-semibold text-slate-900 dark:text-white">Vô hiệu hóa ca làm việc</h3>
                <p class="text-sm text-slate-500 dark:text-slate-400">Ca sẽ bị tắt, dữ liệu xếp ca cũ vẫn giữ nguyên.</p>
            </div>
        </div>
        <p class="text-sm text-slate-700 dark:text-slate-300 mb-5">
            Xác nhận vô hiệu hóa ca <strong id="deleteShiftName"></strong>?
        </p>
