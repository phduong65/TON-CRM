...
<header
    ...
    <div class="flex items-center gap-1 px-3 shrink-0 border-l border-slate-100 dark:border-slate-700">
        ...
        <div class="relative" id="notif-dropdown">
            ...
            <div id="notif-menu"
                class="hidden absolute right-0 mt-1.5 w-[calc(100vw-1rem)] sm:w-[360px] bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-2xl z-[300] overflow-hidden">
